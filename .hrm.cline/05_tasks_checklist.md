...
- [ ] **Typography**: Inter font for UI/body text, JetBrains Mono for IDs/data per .hrm.cline/02_components.md
- [ ] **Color Tokens**: nexus-primary-600 (#6d4de6) for primary actions, nexus-gray-50/100/900 for backgrounds/text
- [ ] **Layout Structure**: App Header (h-16), Sidebar Navigation (w-64), Primary Workspace (ml-64 mt-16)
- [ ] **Shape System**: rounded-none for inputs, rounded-sm for cards/buttons per Olivine UI canon
- [ ] **Shadow System**: shadow-nexus-sm for cards, shadow-2xl for modals
- [ ] **Responsive Design**: Mobile compatibility with breakpoint adjustments
