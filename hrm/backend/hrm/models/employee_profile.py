...
class EmployeeProfile(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['company_code', 'employee'], name='idx_profile_employee'),
            models.Index(fields=['company_code', 'profile_visibility'], name='idx_profile_visibility'),
            models.Index(fields=['employee', 'is_active'], name='idx_employee_active'),
        ]
        constraints = [
            models.UniqueConstraint(fields=['company_code', 'employee'], name='uk_profile_employee'),
        ]
...
class EmployeeSkill(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['company_code', 'employee'], name='idx_skill_employee'),
            models.Index(fields=['company_code', 'skill_category'], name='idx_skill_category'),
            models.Index(fields=['employee', 'is_active'], name='idx_skill_active'),
        ]
...
class EmployeeDocument(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['company_code', 'employee'], name='idx_doc_employee'),
            models.Index(fields=['company_code', 'document_type'], name='idx_doc_type'),
            models.Index(fields=['employee', 'is_active'], name='idx_doc_active'),
        ]
...
class SkillCategory(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['company_code', 'is_active'], name='idx_skill_cat_active'),
            models.Index(fields=['parent_category'], name='idx_parent_category'),
        ]
