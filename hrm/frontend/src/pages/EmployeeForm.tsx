...
import { User, Building, Calendar, DollarSign, MapPin, Phone, Mail, User as UserIcon, CreditCard, Shield, Home, Settings, Users, Briefcase, UserCheck, FileText, Award } from 'lucide-react'
...
export const EmployeeForm: React.FC<EmployeeFormProps> = ({
  ...
  const [formData, setFormData] = useState<EmployeeFormData>({
    ...
    remoteWorkEligible: employee?.remoteWorkEligible || false,
    remoteWorkPercentage: employee?.remoteWorkPercentage || 0,
    
    // Manager Information
    managerName: employee?.managerName || '',
    hrBusinessPartnerName: employee?.hrBusinessPartnerName || '',
    ...
    // Benefits Information
    benefitsEligibilityDate: employee?.benefitsEligibilityDate || '',
    benefitsPackageName: employee?.benefitsPackageName || '',
    healthInsuranceEligible: employee?.healthInsuranceEligible || false,
    dentalInsuranceEligible: employee?.dentalInsuranceEligible || false,
    visionInsuranceEligible: employee?.visionInsuranceEligible || false,
    retirementPlanEligible: employee?.retirementPlanEligible || false,
    lifeInsuranceEligible: employee?.lifeInsuranceEligible || false,
    
    // Emergency Contacts
    primaryEmergencyContactName: employee?.primaryEmergencyContactName || '',
    primaryEmergencyContactRelationship: employee?.primaryEmergencyContactRelationship || '',
    primaryEmergencyContactPhone: employee?.primaryEmergencyContactPhone || '',
    secondaryEmergencyContactName: employee?.secondaryEmergencyContactName || '',
    secondaryEmergencyContactRelationship: employee?.secondaryEmergencyContactRelationship || '',
    secondaryEmergencyContactPhone: employee?.secondaryEmergencyContactPhone || '',
    
    // Status Information
    isActive: employee?.isActive !== undefined ? employee.isActive : true,
    isConfidential: employee?.isConfidential || false,
    isKeyEmployee: employee?.isKeyEmployee || false,
    isHighPotential: employee?.isHighPotential || false,
    terminationDate: employee?.terminationDate || '',
    terminationReason: employee?.terminationReason || '',
    rehireEligible: employee?.rehireEligible !== undefined ? employee.rehireEligible : true,
    ...
    addressType: employee?.addressType || 'HOME',
    isPrimaryAddress: employee?.isPrimaryAddress !== undefined ? employee.isPrimaryAddress : true,
    
    // System Access
    username: employee?.username || '',
    role: employee?.role || 'Employee',
    departmentAccess: employee?.departmentAccess || []
  })
