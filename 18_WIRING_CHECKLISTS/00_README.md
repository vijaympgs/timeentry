...
```
Need to understand UI standards?
  → Go to: 14_UI_CANON/04_Frontend_UI_Canon.md

Need to understand transaction patterns?
  → Go to: 14_UI_CANON/TXN-M.md

Need to implement a master data list page?
  → You're in the right place! Use: MASTER_DATA_WIRING.md

Need to implement a transaction form?
  → You're in the right place! Use: TRANSACTION_FORM_WIRING.md

Need to add workflow actions?
  → You're in the right place! Use: WORKFLOW_WIRING.md
```
...
**For**: Employee, Department, Account, Contact, Category (Master Data List Pages)
